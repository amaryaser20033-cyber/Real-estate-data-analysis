...
Dataset Description :
The dataset contains 2,537 property sale records stored in a single main sheet within an Excel workbook. The project also includes a Pivot Table sheet used for analysis and a Dashboard sheet for visualization and insights presentation.
...
Conclusion :
This analysis explored 2,537 real estate transactions across 8 localities over 13 years. It uncovered key patterns such as consistently strong above-estimate selling performance, a market dominated by Single Family homes, and several data quality issues that should be addressed before deeper analysis. Overall, the project demonstrates practical skills in data cleaning, exploratory analysis, pivot tables, and dashboard creation using Excel.
